...
{/*  type     ,strText                                               ,bEnable,minValue,maxValue,ptstrDataDisp,xBasePosOffsetOnData,yPosAdd,bWrapTrig,widthAddOnData */
    ...
    {PCT_COMBO,TEXT("13 OP2 ATTACK RATE"                            ),TRUE   ,0, 31, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("14 OP2 DECAY 1 RATE"                           ),TRUE   ,0, 31, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("15 OP2 DECAY 2 RATE"                           ),TRUE   ,0, 31, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("16 OP2 RELEASE RATE"                           ),TRUE   ,0, 15, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("17 OP2 DECAY 1 LEVEL"                          ),TRUE   ,0, 15, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("18 OP2 KEYBOARD SCALING LEVEL"                 ),TRUE   ,0, 99, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("19 OP2 KEYBOARD SCALING RATE"                  ),TRUE   ,0,  3, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("20 OP2 EG BIAS SENSITIVITY"                    ),TRUE   ,0,  7, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("21 OP2 AMPLITUDE MODULATION ENABLE"            ),TRUE   ,0,  1, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("22 OP2 KEY VELOCITY"                           ),TRUE   ,0,  7, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("23 OP2 OUTPUT LEVEL"                           ),TRUE   ,0, 99, NULL                ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("24 OP2 OSCILLATOR FREQUENCY"                   ),TRUE   ,0, 63, strTblFrequency     ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("25 OP2 DETUNE"                                 ),TRUE   ,0,  6, strTblDetune        ,  0,20,FALSE,  0},
    {PCT_COMBO,TEXT("26 OP3 ATTACK RATE"                            ),TRUE   ,0, 31, NULL                ,  0, 0,TRUE ,  0},
    {PCT_COMBO,TEXT("27 OP3 DECAY 1 RATE"                           ),TRUE   ,0, 31, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("28 OP3 DECAY 2 RATE"                           ),TRUE   ,0, 31, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("29 OP3 RELEASE RATE"                           ),TRUE   ,0, 15, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("30 OP3 DECAY 1 LEVEL"                          ),TRUE   ,0, 15, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("31 OP3 KEYBOARD SCALING LEVEL"                 ),TRUE   ,0, 99, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("32 OP3 KEYBOARD SCALING RATE"                  ),TRUE   ,0,  3, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("33 OP3 EG BIAS SENSITIVITY"                    ),TRUE   ,0,  7, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("34 OP3 AMPLITUDE MODULATION ENABLE"            ),TRUE   ,0,  1, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("35 OP3 KEY VELOCITY"                           ),TRUE   ,0,  7, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("36 OP3 OUTPUT LEVEL"                           ),TRUE   ,0, 99, NULL                ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("37 OP3 OSCILLATOR FREQUENCY"                   ),TRUE   ,0, 63, strTblFrequency     ,  0, 0,FALSE,  0},
    {PCT_COMBO,TEXT("38 OP3 DETUNE"                                 ),TRUE   ,0,  6, strTblDetune        ,  0, 0,FALSE,  0},
