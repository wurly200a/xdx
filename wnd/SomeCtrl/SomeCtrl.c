...
static S_SOME_CTRL ctrlListTbl[SOME_CTRL_MAX] =
{
    ...
    {SOME_CTRL_GROUP_1VOICE   , TEXT("button")   , TEXT("OP3")        ,  5,415, 300 ,280 ,FALSE ,0    , 0    ,WS_EX_TRANSPARENT,(WS_CHILD|BS_GROUPBOX)                  },
    {SOME_CTRL_GROUP_1VOICE   , TEXT("button")   , TEXT("OP2")        ,315,135, 300 ,280 ,FALSE ,0    , 0    ,WS_EX_TRANSPARENT,(WS_CHILD|BS_GROUPBOX)                  },
