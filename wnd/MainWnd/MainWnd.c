...
//            Dx100CtrlSeqStart(DX100_CTRL_SEQ_METHOD_SET,DX100_CTRL_SEQ_SYS_COMMON,DX100_CTRL_SEQ_SYS_COMMON);
    ...
    case (PARAM_CTRL_ALL_VOICE_TO_ONE_VOICE_31+PARAM_CTRL_ID_OFFSET):
        DebugWndPrintf("TO 1VOICE,%d\r\n",LOWORD(wParam)-(PARAM_CTRL_ID_OFFSET+PARAM_CTRL_ALL_VOICE_TO_ONE_VOICE_00));
        Dx100voiceCopyFromAllToOne(LOWORD(wParam)-(PARAM_CTRL_ID_OFFSET+PARAM_CTRL_ALL_VOICE_TO_ONE_VOICE_00));
        Dx100CtrlModeSet(DX100_CTRL_MODE_PATCH);
        SomeCtrlGroupDisplay(SOME_CTRL_GROUP_1VOICE);
        break;
