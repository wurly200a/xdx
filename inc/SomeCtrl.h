...
typedef enum
{
    ...
    SOME_CTRL_MODE_PERFORMANCE       ,
    SOME_CTRL_MODE_PATCH             ,
    SOME_CTRL_MODE_GM                ,
    SOME_CTRL_GROUP_BOX2             ,
    SOME_CTRL_PATCH_NUM_SELECT       ,
    SOME_CTRL_PATCH_GET_BUTTON       ,
    SOME_CTRL_PATCH_SET_BUTTON       ,
    SOME_CTRL_PATCH_COMMON           ,
    SOME_CTRL_PATCH_TONE1            ,
    SOME_CTRL_PATCH_TONE2            ,
    SOME_CTRL_PATCH_TONE3            ,
    SOME_CTRL_PATCH_TONE4            ,
