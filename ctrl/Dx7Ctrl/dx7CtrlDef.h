...
#define DX7_DUMP_REQ_FORMAT_1VOICE  0x03
#define DX7_DUMP_REQ_FORMAT_32VOICE 0x04
...
enum
{
    ...
    DX7_SYSEX_1VOICE_FOOTER_CHECKSUM          =99,                                                 /*  99  0x63         */
    DX7_SYSEX_1VOICE_FOOTER_ETX               ,                                                    /* 100  0x64         */
...
enum
{
    ...
    DX7_SYSEX_VMEM_73  ,/*  73 0x49 dummy */
    DX7_SYSEX_VMEM_74  ,/*  74 0x4A dummy */
    DX7_SYSEX_VMEM_75  ,/*  75 0x4B dummy */
    DX7_SYSEX_VMEM_76  ,/*  76 0x4C dummy */
    DX7_SYSEX_VMEM_77  ,/*  77 0x4D dummy */
    DX7_SYSEX_VMEM_78  ,/*  78 0x4E dummy */
    DX7_SYSEX_VMEM_79  ,/*  79 0x4F dummy */
    DX7_SYSEX_VMEM_80  ,/*  80 0x50 dummy */
    DX7_SYSEX_VMEM_81  ,/*  81 0x51 dummy */
    DX7_SYSEX_VMEM_82  ,/*  82 0x52 dummy */
    DX7_SYSEX_VMEM_83  ,/*  83 0x53 dummy */
    DX7_SYSEX_VMEM_84  ,/*  84 0x54 dummy */
    DX7_SYSEX_VMEM_85  ,/*  85 0x55 dummy */
    DX7_SYSEX_VMEM_86  ,/*  86 0x56 dummy */
    DX7_SYSEX_VMEM_87  ,/*  87 0x57 dummy */
    DX7_SYSEX_VMEM_88  ,/*  88 0x58 dummy */
    DX7_SYSEX_VMEM_89  ,/*  89 0x59 dummy */
    DX7_SYSEX_VMEM_90  ,/*  90 0x5A dummy */
    DX7_SYSEX_VMEM_91  ,/*  91 0x5B dummy */
    DX7_SYSEX_VMEM_92  ,/*  92 0x5C dummy */
    DX7_SYSEX_VMEM_93  ,/*  93 0x5D dummy */
    DX7_SYSEX_VMEM_94  ,/*  94 0x5E dummy */
    DX7_SYSEX_VMEM_95  ,/*  95 0x5F dummy */
    DX7_SYSEX_VMEM_96  ,/*  96 0x60 dummy */
    DX7_SYSEX_VMEM_97  ,/*  97 0x61 dummy */
    DX7_SYSEX_VMEM_98  ,/*  98 0x62 dummy */
    DX7_SYSEX_VMEM_99  ,/*  99 0x63 dummy */
    DX7_SYSEX_VMEM_100 ,/* 100 0x64 dummy */
    DX7_SYSEX_VMEM_101 ,/* 101 0x65 dummy */
    DX7_SYSEX_VMEM_102 ,/* 102 0x66 dummy */
    DX7_SYSEX_VMEM_103 ,/* 103 0x67 dummy */
    DX7_SYSEX_VMEM_104 ,/* 104 0x68 dummy */
    DX7_SYSEX_VMEM_105 ,/* 105 0x69 dummy */
    DX7_SYSEX_VMEM_106 ,/* 106 0x6A dummy */
    DX7_SYSEX_VMEM_107 ,/* 107 0x6B dummy */
    DX7_SYSEX_VMEM_108 ,/* 108 0x6C dummy */
    DX7_SYSEX_VMEM_109 ,/* 109 0x6D dummy */
    DX7_SYSEX_VMEM_110 ,/* 110 0x6E dummy */
    DX7_SYSEX_VMEM_111 ,/* 111 0x6F dummy */
    DX7_SYSEX_VMEM_112 ,/* 112 0x70 dummy */
    DX7_SYSEX_VMEM_113 ,/* 113 0x71 dummy */
    DX7_SYSEX_VMEM_114 ,/* 114 0x72 dummy */
    DX7_SYSEX_VMEM_115 ,/* 115 0x73 dummy */
    DX7_SYSEX_VMEM_116 ,/* 116 0x74 dummy */
    DX7_SYSEX_VMEM_117 ,/* 117 0x75 dummy */
    DX7_SYSEX_VMEM_118 ,/* 118 0x76 dummy */
    DX7_SYSEX_VMEM_119 ,/* 119 0x77 dummy */
    DX7_SYSEX_VMEM_120 ,/* 120 0x78 dummy */
    DX7_SYSEX_VMEM_121 ,/* 121 0x79 dummy */
    DX7_SYSEX_VMEM_122 ,/* 122 0x7A dummy */
    DX7_SYSEX_VMEM_123 ,/* 123 0x7B dummy */
    DX7_SYSEX_VMEM_124 ,/* 124 0x7C dummy */
    DX7_SYSEX_VMEM_125 ,/* 125 0x7D dummy */
    DX7_SYSEX_VMEM_126 ,/* 126 0x7E dummy */
    DX7_SYSEX_VMEM_127 ,/* 127 0x7F dummy */
    DX7_SYSEX_VMEM_MAX
};
